...
<html>
    ...
    <body>
        <div align="center container">
            <form:form id="editForm"  class="form-inline" action="edit.htm" method="post" modelAttribute="userType" onsubmit="return false;">
                <div class="col-md-8">
                    <div class="row centralize-flex">
                        <div class="form-group">
                            <form:hidden path="userTypeId"  class="form-control" required="required"/>
                ...
                <button class="btn btn-primary editSubmitButton" type="submit" ><spring:message code="userType.fulledit" text="message not found"/></button>
